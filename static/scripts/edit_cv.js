...
function collectFormData() {
  ...
  for (let i = 1; i <= educationCount; i++) {
    ...
    if (degreeEl && degreeEl.closest(".dynamic-section")) {
      const education = {
        ...
        location: document.querySelector(`[name="education_location_${i}"]`)
          .value,
  ...
  for (let i = 1; i <= experienceCount; i++) {
    ...
    if (titleEl && titleEl.closest(".dynamic-section")) {
      const experience = {
        title: titleEl.value,
        company: document.querySelector(`[name="experience_company_${i}"]`)
          .value,
        date: document.querySelector(`[name="experience_date_${i}"]`).value,
        location: document.querySelector(`[name="experience_location_${i}"]`)
          .value,
  ...
  for (let i = 1; i <= projectCount; i++) {
    ...
    if (titleEl && titleEl.closest(".dynamic-section")) {
      const project = {
        title: titleEl.value,
        description: document.querySelector(`[name="project_description_${i}"]`)
          .value,
